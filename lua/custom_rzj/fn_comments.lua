-- @file: custom_rzj/fn_comments.lua
-- @mission: Módulo completo de alternância de comentários em linha e bloco com atalhos integrados
...
-- Autocommands para definir o commentstring por FileType
...
-- Registro automático dos atalhos integrados
...
vim.keymap.set({ "n", "v" }, "gb", function()
    M.toggle_block()
...
-- fn_comments.lua
-- 
-- Pressione <leader>cc para linhas, ou <leader>cb / gb para blocos.
-- ===========================================================